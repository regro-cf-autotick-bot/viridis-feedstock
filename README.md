About viridis-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/viridis-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3643&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/viridis-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `viridis` can be installed with `conda`:
...
```
mamba install viridis
```

It is possible to list all of the versions of `viridis` available on your platform with `conda`:
...
```
mamba search viridis --channel conda-forge
```
...
mamba repoquery search viridis --channel conda-forge

# List packages depending on `viridis`:
mamba repoquery whoneeds viridis --channel conda-forge

# List dependencies of `viridis`:
mamba repoquery depends viridis --channel conda-forge
```
